      ...
      <div class="col-md-6 address_div">
      	...
      	<div class="payment_div">
      		...
      		<div class="row" style="border: 1px solid #C28B85;width: 100%;margin-left: 0px;">
      			<div class="col-md-7">
      				<label><input type="radio" name="" >&nbsp;Razorpay Secure (UPI, Cards, Wallets,  &nbsp;&nbsp;&nbsp;&nbsp;NetBanking)</label>
      			</div> 
      			<div class="col-md-5">
      			...
      			<div class="col-md-12">
      				<label><input type="radio" name="" >&nbsp;Cash on Delivery (COD)</label>
      			</div>    			
      		</div>
...
$sum = 0;
$shipping_amount = 170;
$sql="SELECT buy_now_cart.buy_now_cart_id, buy_now_cart.p_id,  buy_now_cart.user_id, buy_now_cart.p_price, buy_now_cart.p_qty as product_qty, buy_now_cart.total, products.p_id, products.p_name, products.p_img FROM buy_now_cart INNER JOIN products ON buy_now_cart.p_id = products.p_id WHERE buy_now_cart.user_id = '$user_id'";
...
?>
          ...
          <div class="col-md-4">
            <h1 style="font-size: 20px;"><?=$row['total']?></h1>
          </div>
        </div>
<?php
    $sum += $row['total'];
...
?>
        ...
        <div class="col-md-6">
          ...
          <h1 style="font-size: 20px;"><?=$sum + $shipping_amount?></h1>
        </div>
        </div>
          </div>
        </div>
