...
<center>
	...
	<br>
		<div class="error_div" style="width:20%;height:35px; background:white ;border-left: 5px solid red;display: inline-flex;visibility: hidden;">
			<h6 style="float: left;margin-left: 15px;color: rgb(152 117 111);margin-top: 7px;">Error:</h6>
...
<div class="box">
  ...
  <input type="text" name="" class="use mobile" style="">
...
<div class="remember-div">
	<button type="button" class="btn " style="text-transform: capitalize;margin-left: 25%!important;background:rgb(190, 147, 142);color: white;" onclick="login()"> Resister Now </button>
	<br><br>
</div>
</div>
</div>
<div class="box-2">
	<div class="container">
	<p class="para"><a style="color:rgb(190, 147, 142);" onclick="backbtn()" href="login.php">Already have an Account? </a></p>
	</div>
</div>
</center>
</body>
