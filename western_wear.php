...
<div style="width: 100%;height: 200px;margin-top: 9.8%;">
	<center>
				<br><br><br>
			<h1 style="font-size: 35px; text-transform: uppercase;color: rgb(190, 147, 142);">WESTERN APPARELS</h1>
			</center>
</div>
<hr>
<div class="container">
<div class="row">
	<div class="col-md-12">
		<div class="row" style="margin-top: 20px;">
			...
			<?php 
			include('db/db.php');
			$sql="SELECT * FROM `products` WHERE cat_id=4";
