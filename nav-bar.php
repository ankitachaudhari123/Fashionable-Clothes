           ...
           <nav id="primary_nav_wrap" style="margin-left: 94%;margin-top: 23%;">
            ...
            <ul>
              <li><i class="fas fa-user" style="font-size: 20px; color: rgb(190, 147, 142);"></i>
                <ul style="background: #fff8f7;border-radius: 5px; ">
                  ...
                  <li><a href="php/logout.php" style="color:rgb(190, 147, 142);font-size: 15px;font-weight: 200; ">Logout</a></li>
                </ul>
              </li>   
            </ul>
            <?php
            ...
            <ul>
              <li><i class="fa-regular fa-user" style="font-size: 20px; color: rgb(190, 147, 142);"></i>
                <ul>
                  <li><a href="login.php" style="color:rgb(190, 147, 142);font-size: 15px;font-weight: 200; ">Login</a></li>
                  <li><a href="resister.php" style="color:rgb(190, 147, 142);font-size: 15px;font-weight: 200; ">Register</a></li>
                </ul>
              </li>   
            </ul>
            <?php
